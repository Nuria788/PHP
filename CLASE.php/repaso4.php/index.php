...
<body>
    <form action="sustitucion.php" method="post">
        <p>Pon un nombre <input type="text" name="nombre"></p>
        <p>Pon otro nombre <input type="text" name="nombre1"></p>
        <p>Pon un texto <textarea name="texto"></p>
